...
import { SiriusTicketingSystemClient } from '@ad/src/core/ticketing/sirius';
...
describeWhenManual('SiriusTicketingSystemClient', () => {
  const client = new SiriusTicketingSystemClient(process.env.TEST_SIRIUS_ACCESS_KEY || '', process.env.TEST_SIRIUS_SECRET_KEY || '');
