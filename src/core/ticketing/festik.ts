...
import { missingFestikEventsRightsError } from '@ad/src/models/entities/errors';
import {
...
export class FestikTicketingSystemClient implements TicketingSystemClient {
  public readonly baseUrl = 'https://www.festik.fr/api';
  ...
  public async getEventsSeries(fromDate: Date, toDate?: Date): Promise<LiteEventSerieWrapperSchemaType[]> {
    ...
    if (
      ...
      throw missingFestikEventsRightsError;
    }
