...
import { SeeticketsTicketingSystemClient } from '@ad/src/core/ticketing/seetickets';
...
describeWhenManual('SeeticketsTicketingSystemClient', () => {
  const client = new SeeticketsTicketingSystemClient(process.env.TEST_SEETICKETS_ACCESS_KEY || '', process.env.TEST_SEETICKETS_SECRET_KEY || '');
