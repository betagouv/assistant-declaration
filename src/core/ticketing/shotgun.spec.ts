...
describeWhenManual('ShotgunTicketingSystemClient', () => {
  const client = new ShotgunTicketingSystemClient(process.env.TEST_SHOTGUN_ACCESS_KEY || '', process.env.TEST_SHOTGUN_SECRET_KEY || '');
