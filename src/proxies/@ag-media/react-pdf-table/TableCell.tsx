...
export default function TableCell({ children, weighting, _firstColumn, _lastColumn, _firstRow, _lastRow, ...rest }: TableCellProps) {
  ...
  }, [tableStyle, _firstColumn, _lastColumn, _firstRow, _lastRow, borderMargin]);
  ...
  return (
    <View
      ...
      style={[
        ...
        ...((Array.isArray(tdStyle) ? tdStyle : [tdStyle]) as any),
        ...((Array.isArray(rest.style) ? rest.style : [rest.style]) as any),
      ]}
    >
      {content}
    </View>
