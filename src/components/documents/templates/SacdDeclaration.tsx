    ...
    >
      ...
      <View style={styles.gridContainer}>
            ...
            {props.eventsWrappers.map((eventWrapper, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell style={{ justifyContent: 'flex-end' }}>{currencyFormatter.format(includingTaxesAmount)}</TableCell>
        ...
        <View style={styles.gridItem}>
          ...
          <Text>{currencyFormatter.format(props.sacdDeclaration.averageTicketPrice)}</Text>
        </View>
        <View style={styles.gridItem}>
          ...
          <Table weightings={[2, 1, 1, 1, 1]} tdStyle={{ padding: 5 }}>
            ...
            {props.sacdDeclaration.accountingEntries.map((accountingEntry, index) => (
              ...
              >
                ...
                <TableCell style={{ justifyContent: 'flex-end' }}>{currencyFormatter.format(accountingEntry.includingTaxesAmount)}</TableCell>
