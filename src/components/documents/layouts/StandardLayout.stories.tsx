...
EmptyStory.args = {
  title: '',
  children: <PageLayout></PageLayout>,
};
  ...
  children: (
    <>
      <PageLayout showHeader>
        ...
        <Text style={styles.p}>
          Sunt vero accusamus sunt sit adipisci eos ut. Dolores neque et sunt. Id dolores qui fugiat corporis eum. Voluptas omnis molestiae modi vel
          ut molestiae. Nesciunt eum dolorem quis. Vitae dignissimos repellat voluptate voluptatibus fugiat placeat eligendi. Qui asperiores
          praesentium ullam atque nisi sed. Soluta quasi eum. Ut iure maiores ipsam numquam aliquid perferendis voluptatem dolores.
        </Text>
        <Text style={styles.p}>
        ...
        <Text style={styles.p}>
          ...
          dolore deleniti aliquid veritatis ea iste nihil. Excepturi totam voluptatibus adipisci. Minus aspernatur eos omnis repudiandae omnis. Sit
          sit alias asperiores facere alias nam rerum eius. Optio aperiam repellat cum cupiditate sed cupiditate. Iusto aliquam aperiam quasi odio
          culpa. Nulla perferendis numquam reprehenderit veniam. Veritatis consequuntur voluptatibus laborum sed perspiciatis. Nostrum et mollitia
          aperiam atque quia earum nisi.
        </Text>
        <Text style={styles.p}>
          ...
          voluptas. Aut in dolores amet et. Magni accusantium sit dignissimos blanditiis eum. Illum minima rerum quisquam. Aut cumque saepe
          accusantium saepe ducimus dolorum et reiciendis. Qui dolorum repellendus sed iste sed hic voluptatem quia architecto. Hic aut eveniet ut
          dolorem magnam tempora et est maiores. Dolore soluta ea debitis autem error aut molestiae. Iusto sed assumenda cupiditate quia voluptatem.
          Tempora ea nihil aliquam asperiores dignissimos eum culpa praesentium ullam. Eaque minima ullam sunt beatae adipisci est qui saepe et. Nam
          expedita nostrum repellat illum totam suscipit. Consequatur eos quia vero molestiae ad natus esse dolorem fugit. Sequi est officia ut id in
          ipsam occaecati quo.
        </Text>
        <Text style={styles.p}>
          ...
          repudiandae aut ut quis nemo nihil qui. Eos nihil alias quo molestiae ut voluptas sint. Illo consequuntur non explicabo possimus. Sequi
          optio eos et incidunt sint nulla eveniet. Dolor saepe quis dolorem nobis debitis quas qui. Laboriosam ratione cum unde omnis ab qui sequi
          culpa quas. Maxime doloremque nemo omnis quas officiis. Distinctio sed dolor perferendis perferendis tempora.
        </Text>
      </PageLayout>
    </>
  ),
