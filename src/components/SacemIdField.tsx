...
import { sacemIdMask } from '@ad/src/utils/imask';
...
interface SacemIdInputProps extends SubformType {
  label: string;
  errorMessage?: string;
}

export function SacemIdInput(props: SacemIdInputProps) {
  const { inputRef: maskInputRef } = useSacemIdInput({
