import { Lang } from '@ad/src/utils/routes/common';
import { routes } from '@ad/src/utils/routes/list';
...
export const linkRegistry = new LinkRegistry({ defaultLang: 'en', baseUrl: getBaseUrl() });
