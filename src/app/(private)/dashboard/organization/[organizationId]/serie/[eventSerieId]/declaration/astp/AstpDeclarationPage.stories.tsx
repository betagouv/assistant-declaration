...
import { AstpDeclarationPage } from '@ad/src/app/(private)/dashboard/organization/[organizationId]/serie/[eventSerieId]/declaration/astp/AstpDeclarationPage';
...
type ComponentType = typeof AstpDeclarationPage;
const { generateMetaDefault, prepareStory } = StoryHelperFactory<ComponentType>();

export default {
  title: 'Pages/AstpDeclaration',
  component: AstpDeclarationPage,
  ...generateMetaDefault({
    parameters: {},
  }),
...
const Template: StoryFn<ComponentType> = (args) => {
  return <AstpDeclarationPage {...args} />;
};
