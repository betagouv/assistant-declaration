...
export const sacemDeclarations: SacemDeclarationSchemaType[] = [
  SacemDeclarationSchema.parse({
    ...
    performanceType: `Spectacles d'humour`,
  ...
  SacemDeclarationSchema.parse({
    ...
    managerTitle: 'Gérant',
    performanceType: 'Concerts et spectacles de variété',
  ...
  SacemDeclarationSchema.parse({
    ...
    performanceType: 'Spectacles de cirque traditionnel',
...
export const sacemDeclarationsWrappers: SacemDeclarationWrapperSchemaType[] = [
  SacemDeclarationWrapperSchema.parse({
    ...
    placeholder: {
      ...
      placePostalCode: [sacemDeclarations[1].placePostalCode],
      ...
      performanceType: [sacemDeclarations[1].performanceType, sacemDeclarations[2].performanceType],
      declarationPlace: [sacemDeclarations[1].declarationPlace, sacemDeclarations[2].declarationPlace],
