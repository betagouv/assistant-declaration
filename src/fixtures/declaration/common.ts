...
export const declarations: DeclarationSchemaType[] = [
  DeclarationSchema.parse({
    ...
    eventSerie: {
      ...
      introductionFeesExpensesExcludingTaxes: eventsSeries[0].expensesExcludingTaxes,
      circusSpecificExpensesExcludingTaxes: eventsSeries[0].expensesExcludingTaxes,
    },
  ...
  DeclarationSchema.parse({
    ...
    eventSerie: {
      ...
      introductionFeesExpensesExcludingTaxes: eventsSeries[1].expensesExcludingTaxes,
      circusSpecificExpensesExcludingTaxes: eventsSeries[1].expensesExcludingTaxes,
    },
