...
export const organizations: OrganizationSchemaType[] = [
  OrganizationSchema.parse({
    ...
    headquartersAddressId: 'd79cb3ba-745e-5d9a-8903-4a02327a7e01',
    sacemId: '123456789',
    sacdId: '123456789',
  ...
  OrganizationSchema.parse({
    ...
    officialHeadquartersId: '23456789100022',
    headquartersAddressId: 'd79cb3ba-745e-5d9a-8903-4a02327a7e02',
    sacemId: '223456789',
    sacdId: '223456789',
  ...
  OrganizationSchema.parse({
    ...
    officialHeadquartersId: '34567891200033',
    headquartersAddressId: 'd79cb3ba-745e-5d9a-8903-4a02327a7e03',
    sacemId: '323456789',
    sacdId: '323456789',
