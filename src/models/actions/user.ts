...
export const UpdateProfilePrefillSchema = zx.deepPartial(UpdateProfileSchema);
...
export const GetProfilePrefillSchema = zx.deepPartial(GetProfileSchema);
...
export const GetInterfaceSessionPrefillSchema = zx.deepPartial(GetInterfaceSessionSchema);
...
export const GetLiveChatSettingsPrefillSchema = zx.deepPartial(GetLiveChatSettingsSchema);
